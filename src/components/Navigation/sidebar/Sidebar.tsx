  ...
  return (
    <aside
      ...
      className={`fixed w-full lg:w-fit h-screen lg:h-auto top-0 left-0 lg:relative tracking-wide ${
        isOpenSidebar ? "lg:block" : "hidden lg:block"
      } bg-white/30 backdrop-blur-sm`}
    >
      <div className="w-72 max-w-[90%] p-8 lg:p-0 bg-white lg:bg-auto border-r h-full lg:h-fit lg:border-r-0 sticky top-[119px]">
        <button
          onClick={() => {
            setIsOpenSidebar(false);
          }}
